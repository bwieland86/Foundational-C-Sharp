           ...
           for(int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    {
                        Console.WriteLine("The following pet has missing information:");
                        Console.WriteLine(ourAnimals[i, 0].ToString());
                        Console.WriteLine(ourAnimals[i, 2].ToString());
                        Console.WriteLine(ourAnimals[i, 4].ToString());
                        Console.WriteLine();

                        do
                        {
                            Console.WriteLine($"Please enter the pet age for {ourAnimals[i, 0].ToString()}");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                animalAge = readResult;
                        ...
                        do
                        {
                            Console.WriteLine($"Please enter a physical description for {ourAnimals[i, 0].ToString()} (size, color, breed, gender, weight, housebroken)");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                animalPhysicalDescription = readResult.ToLower();
           ...
           for(int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 5] == "Personality: ")
                    {
                        Console.WriteLine("The following pet has missing information:");
                        Console.WriteLine(ourAnimals[i, 0].ToString());
                        Console.WriteLine(ourAnimals[i, 3].ToString());
                        Console.WriteLine(ourAnimals[i, 5].ToString());
                        Console.WriteLine();

                        do
                        {
                            Console.WriteLine($"Please enter a nickname for {ourAnimals[i, 0].ToString()}");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                animalNickname = readResult.ToLower();
                        ...
                        do
                        {
                            Console.WriteLine($"Please enter a personality description for {ourAnimals[i, 0].ToString()} (likes or dislikes, tricks, energy level)");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                animalPersonalityDescription = readResult.ToLower();
