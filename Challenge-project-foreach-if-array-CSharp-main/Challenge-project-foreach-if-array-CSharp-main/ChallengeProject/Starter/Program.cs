...
foreach (string name in studentNames)
{
    ...
    */
    ...
    currentStudentOverallGrade = (decimal) sumOverallScores / examAssignments;
    currentStudentExtraCreditScore = (decimal) sumExtraCreditScores / extraCreditAssignments;
    ...
    Console.WriteLine($"{currentStudent}\t\t{currentStudentExamScore}\t\t{currentStudentOverallGrade.ToString("F2")}\t{currentStudentLetterGrade}\t\t{currentStudentExtraCreditScore} ({currentStudentExtraCreditPoints.ToString("F2")} pts)");
}
